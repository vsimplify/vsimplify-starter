  ...
  return (
    <footer className="w-full border-t bg-white py-4">
      <div className="max-w-7xl mx-auto flex flex-col items-center gap-4 px-4">
        {/* Powered By Section with Social Links */}
        <div className="flex flex-col sm:flex-row items-center justify-between w-full gap-4">
          {/* Powered By */}
          <div className="flex items-center gap-2">
            <span className="text-gray-500">Powered by</span>
            <Link
              href="https://vsimplifyit.com"
              target="_blank"
          ...
          <div className="flex items-center space-x-6">
            <Link
              href="https://twitter.com/vsimplifyit"
            ...
            <Link
              href="https://linkedin.com/company/vsimplifyit"
              className="text-gray-400 hover:text-gray-600 transition-colors duration-200"
              aria-label="LinkedIn"
              target="_blank"
            >
            ...
            <Link
              href="https://github.com/vsimplifyit"
              className="text-gray-400 hover:text-gray-600 transition-colors duration-200"
              aria-label="GitHub"
              target="_blank"
            >

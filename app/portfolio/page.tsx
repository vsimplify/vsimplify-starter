...
const mockPortfolios: Portfolio[] = [
  { id: '1', title: 'Portfolio 1', status: 'Active', domainId: 1, user_id: 'user1', created_at: new Date().toISOString() },
  { id: '2', title: 'Portfolio 2', status: 'Completed', domainId: 2, user_id: 'user1', created_at: new Date().toISOString() },
]

const mockProjects: Project[] = [
  { id: 1, title: 'Project 1', status: 'In Progress', domainId: 1, email: 'user@example.com', goal: 'Goal 1', nugget: 'Nugget 1', objective: 'Objective 1', outcome: 'Outcome 1', dueOn: new Date().toISOString(), createdAt: new Date().toISOString(), user_id: 'user1' },
  { id: 2, title: 'Project 2', status: 'Completed', domainId: 1, email: 'user@example.com', goal: 'Goal 2', nugget: 'Nugget 2', objective: 'Objective 2', outcome: 'Outcome 2', dueOn: new Date().toISOString(), createdAt: new Date().toISOString(), user_id: 'user1' },
]

const mockMissions: Mission[] = [
  { id: 1, name: 'Mission 1', process: 'SEQUENTIAL', project_id: 1, domainId: 1, email: 'user@example.com', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString(), user_id: 'user1', inTokens: 0, outTokens: 0, abandonedForTokens: false, verbose: false },
  { id: 2, name: 'Mission 2', process: 'HIERARCHICAL', project_id: 1, domainId: 1, email: 'user@example.com', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString(), user_id: 'user1', inTokens: 0, outTokens: 0, abandonedForTokens: false, verbose: false },
]

const mockTasks: Task[] = [
  { id: '1', name: 'Task 1', status: 'To Do', missionId: 1, user_id: 'user1' },
  { id: '2', name: 'Task 2', status: 'In Progress', missionId: 1, user_id: 'user1' },
  { id: '3', name: 'Task 3', status: 'Done', missionId: 2, user_id: 'user1' },
]
...
export default function PortfolioDashboard() {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <Select onValueChange={(value) => setSelectedDomain(Number(value))}>

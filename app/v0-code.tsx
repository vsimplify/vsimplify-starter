...
// // Create a custom type that extends SelectProps and includes children
// type CustomSelectProps = SelectProps & {
//   children: ReactNode
// }

// // Create a wrapper component that properly types the children prop
// const Select = ({ children, ...props }: CustomSelectProps) => {
//   return <SelectBase {...props}>{children}</SelectBase>
// }

// // Mock data - replace with actual API calls
// const mockDomains: Domain[] = [
//   { id: 1, identifier: 1, Domain: 'AI', ForUse: 'Research', Audience: 'Scientists', Area: 'Machine Learning', Agents: [], Missions: [], agentAbsent: null },
//   { id: 2, identifier: 2, Domain: 'Web Development', ForUse: 'Commercial', Audience: 'Developers', Area: 'Frontend', Agents: [], Missions: [], agentAbsent: null },
// ]
...
//     goal: 'Improve AI model efficiency',
//     nugget: 'Efficiency boost',
//     objective: 'Reduce computational resources',
//     outcome: 'Faster AI models',
...
//     domainId: 2,
//     email: 'user@example.com',
//     goal: 'Create a versatile CSS framework',
//     nugget: 'Flexibility',
//     objective: 'Support multiple device sizes',
//     outcome: 'Improved web responsiveness',
//     dueOn: new Date().toISOString(),
//     createdAt: new Date().toISOString(),
//     user_id: 'user1'
//   }
...
//   {
//     id: 1,
//     name: 'Implement Pruning Algorithm',
//     process: 'SEQUENTIAL',
//     project_id: 1,
//     domainId: 1,
//     email: 'user@example.com',
...
//   {
//     id: '1',
//     name: 'Research pruning techniques',
//     status: 'In Progress',
//     missionId: 1,
//     user_id: 'user1',
...
//           options={Array.from(new Set(domains.map(d => d.ForUse))).map(forUse => ({ value: forUse, label: forUse }))}
//         >
...
//         <Select onValueChange={setSelectedArea} {...props as CustomSelectProps}>
//           <SelectTrigger className="w-full bg-gray-700 text-white border-gray-600">
